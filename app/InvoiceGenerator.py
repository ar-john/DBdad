...
class InvoiceGenerator:
    ...
    def createInvoice(self, custid, empid):
        ...
        self.c = canvas.Canvas("invoice/invoice" + str(self.invoiceNumber) + ".pdf", pagesize=(200, 250), bottomup=0)
    ...
    def template(self):
        ...
        self.c.drawString(20,229,"(This is system generated invoice)")
        self.c.setFont("Courier-Bold", 5)
    ...
    def createInvoiceGraphics(self, invnum):
        self.c = canvas.Canvas("invoice" + str(invnum) + ".pdf", pagesize=(200, 250), bottomup=0)
        self.template()
        ...
        self.c.drawCentredString(75, self.partCoordinateY, str(partProps[1]))
        self.c.drawCentredString(125, self.partCoordinateY, str(partProps[3]))
        self.c.drawCentredString(148, self.partCoordinateY, str(invoice[4]))
        self.partCoordinateY += 5

        self.c.setFont("Courier-Bold", 3)
        self.c.drawString(20,225,"Sold By: " + str(invoice[2]))
